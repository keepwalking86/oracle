...
ORACLE_FILE=oracle19c.zip
ORACLE_DIR=/home/oracle
ORACLE_PASSWORD=Oracle19c
IPADDRESS=172.16.7.222
...
echo "----------------------------------------"
sleep 5
su oracle -c "$ORACLE_HOME/runInstaller -silent -debug -waitForCompletion -responseFile $ORACLE_HOME/db_install.rsp"
