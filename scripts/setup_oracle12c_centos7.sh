...
echo "${txtyellow}***Installing required packages***${txtreset}
...
echo "${txtyellow}***Creating groups for oracle database***${txtreset}"
...
echo "----------------------------------------"
echo "${txtyellow}***Starting Oracle binaries installation***${txtreset}"
echo "----------------------------------------"
sleep 5
...
###Config Oracle net
echo "---------------------------------------------------"
echo "${txtyellow}***Configuring Oracle Net***${txtreset}"
echo "---------------------------------------------------"
...
echo "---------------------------------------------------"
echo "${txtyellow}***Configuring Oracle Database***${txtreset}"
echo "---------------------------------------------------"
...
#Oracle Instance
echo "${txtyellow}***Creating and starting Oracle instance***${txtreset}"
sleep3
